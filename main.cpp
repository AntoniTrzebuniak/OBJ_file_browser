...
int main( int argc, char** argv )
{
    ...
    initFreeCamera( sceneCenter, sceneDistance );
...
void rysuj( void )
{
    ...
    const glm::mat4 M = glm::translate( glm::mat4( 1.0f ), -sceneCenter );
    const glm::mat4 V = glm::lookAt( camPos, camPos + camFront, camUp );
    MV = V * M;
